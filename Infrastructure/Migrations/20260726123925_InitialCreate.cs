        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllotedTime = table.Column<TimeSpan>(type: "time", nullable: false),
                    CourseId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamQuestionAnswers", x => new { x.AttemptId, x.QuestionId, x.AnswerId });
                    table.ForeignKey(
                        name: "FK_ExamQuestionAnswers_Answers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ExamQuestionAnswers_ExamAttempts_AttemptId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamQuestionAnswers_AnswerId",
